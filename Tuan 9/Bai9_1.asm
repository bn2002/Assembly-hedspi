...
PrintIntArray:
	...
	# initilization for counter loop
...
loop:
	...
	sge $t0, $s2, $s1
	bnez $t0, end_loop
		sll $t0, $s2, 2			# Multiply the loop counter by 4 to get offset(each element is 4 bit)
		add $t0, $t0, $s0		# address of next array elemtent
